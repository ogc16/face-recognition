    ...
    def __init__(self) -> None:
        try:
            ...
            raise DependencyError(
                "Face recognition dependencies are missing. Install the project with "
...
class FaceRecognitionService:
    def __init__(
        ...
        if not 0 < tolerance <= 1:
            raise RecognitionError("Tolerance must be greater than 0 and at most 1")
    ...
    def recognize(self, frame: Any) -> RecognitionResult:
        ...
        for name, known_embedding in self.registry.iter_embeddings():
